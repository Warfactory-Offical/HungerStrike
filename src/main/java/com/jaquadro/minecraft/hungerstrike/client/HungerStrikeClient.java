package com.jaquadro.minecraft.hungerstrike.client;
...
public final class HungerStrikeClient {
    public HungerStrikeClient(IEventBus modBus, ModContainer modContainer) {
