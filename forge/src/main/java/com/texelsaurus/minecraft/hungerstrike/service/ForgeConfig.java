...
public class ForgeConfig implements CommonConfig
{
    ...
    public class ForgeConfigEntry<T> extends CommonConfig.ConfigEntry<T>
    {
        ...
        @Override
        public CommonConfig.ConfigEntry<T> build () {
            if (comment != null)
